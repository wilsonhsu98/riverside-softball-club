...
export default {
  ...
  data() {
    ...
    const prodKey = {
      keys: {
        game_f: '8a80854b783404b001785a53c89941c1',
        stats_pa_f: '8a80854b783404b001785a54633741c2',
        stats_pitcher_f: '8a80854b783404b001785a554a6541c3',
      ...
      frequencyBannerKey: '8a80854b783404b001785a5996f0424e',
      debug: true,
    };
